...
<pre>  <font size="5" color="#3f729b" face="times new roman">Username:<center><input type="text" name="username"></input></center>
    Password:<center><input type="password" name="password"></input></center></font></pre><font size="3" color="black">Wrong Password, Click <a href="signup.html">here</a> to sign up</font>
</div>
