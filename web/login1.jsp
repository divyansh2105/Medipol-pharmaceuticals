...
<div class="first">
<pre>  <font size="5" color="#3f729b" face="times new roman">Username:<center><input type="text" name="username"></input></center><font size="3" color="black">Wrong Username, Click <a href="signup.html">here</a> to sign up</font>
    Password:<center><input type="password" name="password"></input></center></font></pre>
</div>
Enter Captcha  <input type="text" name="code"> <img src="http://localhost:8080/databaseproj/CaptchaServlet">
<div class="s">
    <br>
